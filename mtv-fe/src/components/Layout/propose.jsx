  ...
  return (
    <>
       <div className="flex flex-col p-4 rounded-lg w-full h-full mx-auto md:p-10">
        ...
        <ProposeButton Icon={BookPlus} label="Tạo NCKH" link="/sientific"/>
        <ProposeButton Icon={LaptopMinimalCheck} label="Nghiên cứu đã hoàn thành" link="/funding"/>
        <ProposeButton Icon={ChartNoAxesCombined} label="Báo cáo chi tiết" link="/funding"/>
        </div>
    </div>
    </>
  )
